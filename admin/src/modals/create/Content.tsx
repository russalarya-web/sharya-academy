...
const CreateContent = (props: {show: boolean; classId: number; subjectId: string; chapterId: string; contentType: string; onClose: () => any;}) => {
    const link = currentUrl + "/" + props.contentType + "/create";
